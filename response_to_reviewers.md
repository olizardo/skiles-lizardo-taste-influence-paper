...
* **Status:** `[Addressed]`
* **Location in Manuscript:** Section 2.1 (Sample Recruitment and Survey Administration), Section 2.2 (Inferential Scope and Interpretation of Confidence Intervals), Table 1 (Sample Descriptive Statistics)
* **Response / Actions Taken:**
  - We have substantially expanded Section 3.1 to provide comprehensive details regarding the survey sampling procedure, participant recruitment, quota filtering, and the inferential scope of reported statistics:
...
* **Status:** `[Addressed]`
* **Location in Manuscript:** Section 2.4 (Variables and Measurement: Inverse Probability Weighting and Causal Logic), Section 3.1 (Covariate Balance Across Observational Status Categories, Figure \ref{fig:balance})
* **Response / Actions Taken:**
  ...
  - In Section 2.4 and Section 3.1 of the revised manuscript (`manuscript_R1.tex`), we have added a dedicated, pedagogical explanation of the hybrid observational-experimental setup, the formal mechanics of Inverse Probability Weighting (IPW), and its exact implications for causal interpretation:
    ...
    2. **Pedagogical Mechanics of IPW:** Following Rosenbaum and Rubin (1983), we address this in two formal steps:
       - *Step 1 (Generalized Propensity Scores):* We fit a multinomial logistic regression predicting each respondent's probability of belonging to their observed status consistency quadrant $S_i \in \{1, 2, 3, 4\}$ conditional on exogenous background covariates $\mathbf{X}_i$ (age, gender, race/ethnicity, and parental educational capital):
         $$
