...
Our analysis demonstrates that aesthetic judgments are deeply malleable, but not uniformly so, advancing the sociology of culture in several ways. Primarily, the findings highlight that directionality matters. By replacing a binary ``stay/shift'' conceptualization with a multinomial ``stay/conform/react'' framework, we reveal that cultural influence involves active processes of both emulation and boundary-drawing. Additionally, we identify status inconsistency as a critical driver of change. Respondents with inconsistent status markers, such as working-class individuals with a college degree or middle-class individuals without one, are the most aesthetically fluid. Crucially, they resolve this fluidity differently, leaning heavily into either reactance or conformity depending on their exact social location. Finally, the methodological rigor introduced by incorporating propensity score weighting and validating with ordinal models establishes that these dynamics represent structural sociological realities, rather than statistical artifacts of ordinal scales or observational confounding.
