...
To answer this question, we designed an experimental study to disentangle three distinct social influence mechanisms shaping aesthetic taste for a cultural object. In our study, participants were asked to tell us how they felt about a painting---Whistler's \textit{Nocturne}---on a scale ranging from ``dislike it very much'' to ``like it very much.'' After we obtained this evaluation, in the experimental part of the survey, we told a subset of participants that our survey had so far shown that the group of participants that was most likely to either like (for one subset of participants) or dislike (for another subset) was either people with a PhD and working in higher education, people holding a bachelor's degree in business and working in financial investment, or people with a high school education and working in food service. They then spent between 10 and 20 minutes answering various sociodemographic questions and completing survey modules. Participants were then shown the same painting one last time and asked to provide us with their final take on it, using the same evaluative categories as in the beginning. 
