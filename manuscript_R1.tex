...
\toprule
\textbf{Independent Variable} & \textbf{Model 1: Control Drift (IPW)} & \textbf{Model 2: Pooled DiD} \\
\midrule
Intercept & 4.861$^{***}$ (0.155) & 4.689$^{***}$ (0.114) \\
          & [$t = 31.42$] & [$t = 40.99$] \\
\addlinespace[2pt]
Trial 2 Exposure Drift ($\beta_1$) & +0.032 (0.058) & +0.107$^{*}$ (0.052) \\
                                   & [$t = 0.55$] & [$t = 2.05$] \\
\addlinespace[2pt]
College Degree Main Effect & -0.433$^{\dagger}$ (0.238) & \multicolumn{1}{c}{---} \\
                           & [$t = -1.82$] & \\
\addlinespace[2pt]
Trial 2 $\times$ College Degree ($\beta_2$) & +0.247$^{**}$ (0.082) & \multicolumn{1}{c}{---} \\
                                            & [$t = 3.00$] & \\
\addlinespace[3pt]
\multicolumn{3}{l}{\textit{Treatment Main Effects at Baseline ($\beta_k$):}} \\
\addlinespace[1pt]
\quad Low-Status Like & \multicolumn{1}{c}{---} & +0.095 (0.145) \\
                      & & [$t = 0.66$] \\
\quad High-Status Like & \multicolumn{1}{c}{---} & -0.039 (0.131) \\
                       & & [$t = -0.30$] \\
\quad Low-Status Dislike & \multicolumn{1}{c}{---} & +0.068 (0.145) \\
                        & & [$t = 0.47$] \\
\quad High-Status Dislike & \multicolumn{1}{c}{---} & +0.061 (0.131) \\
                         & & [$t = 0.47$] \\
\quad Generalized Like & \multicolumn{1}{c}{---} & -0.172 (0.163) \\
                       & & [$t = -1.05$] \\
\quad Generalized Dislike & \multicolumn{1}{c}{---} & +0.229 (0.163) \\
                          & & [$t = 1.41$] \\
\addlinespace[3pt]
\multicolumn{3}{l}{\textit{Difference-in-Differences Treatment Effects ($\delta_k = \text{Trial} \times \text{Condition}$):}} \\
\addlinespace[1pt]
\quad Low-Status Like & \multicolumn{1}{c}{---} & -0.128$^{\dagger}$ (0.067) \\
                      & & [$t = -1.93$] \\
\quad High-Status Like & \multicolumn{1}{c}{---} & +0.041 (0.060) \\
                       & & [$t = 0.68$] \\
\quad Low-Status Dislike & \multicolumn{1}{c}{---} & +0.016 (0.066) \\
                        & & [$t = 0.23$] \\
\quad High-Status Dislike & \multicolumn{1}{c}{---} & -0.121$^{*}$ (0.060) \\
                         & & [$t = -2.02$] \\
\quad Generalized Like & \multicolumn{1}{c}{---} & +0.096 (0.075) \\
                       & & [$t = 1.29$] \\
\quad Generalized Dislike & \multicolumn{1}{c}{---} & -0.125$^{\dagger}$ (0.075) \\
                          & & [$t = -1.67$] \\
\midrule
Total College Exposure Drift & +0.279$^{***}$ (0.063) & \multicolumn{1}{c}{---} \\
                             & [$t = 4.43$] & \\
\addlinespace[2pt]
Random Intercept Variance ($\sigma^2_u$) & 2.268 & 2.074 \\
Residual Variance ($\sigma^2_\epsilon$) & 0.592 & 0.243 \\
Observations / Individuals & 354 / 177 & 4,506 / 2,253 \\
Log Likelihood & -487.8 & -6,465.0 \\
\bottomrule
\end{tabular*}
\begin{minipage}{\linewidth}
\vspace{4pt}
\footnotesize
\textit{Note:} $^{\dagger}p < 0.10, ^{*}p < 0.05, ^{**}p < 0.01, ^{***}p < 0.001$. Standard errors in parentheses; $t$-values in brackets. Models estimated via linear mixed-effects with random intercepts for respondents. Model 1 restricts the sample to the unexposed Control Condition ($N = 177$) and incorporates Inverse Probability Weighting (IPW) to balance baseline age, gender, race/ethnicity, and parental education between college and non-college respondents (non-college respondents serve as reference; unweighted estimates yield $\beta_1 = 0.000, p = 1.000$ and $\beta_2 = +0.257, p = 0.0016$). Model 2 estimates the primary unweighted Difference-in-Differences specification across the pooled sample ($N = 2,253$), comparing treatment shifts against the unexposed Control Condition.
\end{minipage}
\end{table}
